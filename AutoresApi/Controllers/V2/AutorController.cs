...
namespace AutoresApi.Controllers.V2
{
    ...
    public class AutorController : ControllerBase
    {
        ...
        // GET: api/Autor
        [HttpGet("getAuthors", Name = "getAuthorsV2")]
        [AllowAnonymous]
        ...
        public async Task<ActionResult<List<AutorDTO>>> GetAutores(/*[FromHeader] string? incluirHATEOAS*/)
        {
            ...
            autores.ForEach(item => item.Nombre = item.Nombre.ToUpper());
            var result = _mapper.Map<List<AutorDTO>>(autores);
            return Ok(result);
        }

        // GET: api/Autor/5
        [HttpGet("getAuthorById/{id}", Name = "getAuthorByIdV2")]
        [AllowAnonymous]
        [ServiceFilter(typeof(HATEOASAuthorFilterAttribute))]
        ...
        [HttpGet("getAuthorByName/{nombre}", Name = "getAuthorByNameV2")]
        ...
        [HttpPut("updateAuthor/{id}", Name = "updateAuthorV2")]
        ...
        // POST: api/Autor
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("createAuthor", Name = "createAuthorV2")]
        ...
        // DELETE: api/Autor/5
        [HttpDelete("deleteAuthor/{id}", Name = "deleteAuthorV2")]
